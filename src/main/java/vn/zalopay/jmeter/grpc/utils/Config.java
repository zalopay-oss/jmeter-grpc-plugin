...
public class Config {
  ...
  public static final boolean USE_SSL =
      Boolean.getBoolean(props.getOrDefault("sampler.use.ssl", "false"));
  public static final String PACKAGE_NAME =
      props.getOrDefault("sampler.package.name", "io.grpc.examples.helloworld");
  ...
  public static final String REQUEST =
      props.getOrDefault("sampler.request", "io.grpc.examples.helloworld.HelloRequest");
